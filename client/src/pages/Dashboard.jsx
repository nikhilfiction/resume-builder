// import { FilePenLine, Form, PencilIcon, PlusIcon, TrashIcon, UploadCloud, XIcon } from 'lucide-react'
// import React, { useEffect, useState } from 'react'
// import { dummyResumeData } from '../assets/assets' // or wherever it actually lives
...
//       <p className='text-2xl font-medium mb-6 bg-gradient-to-r from-skate-600 to-slate-700 bg-clip-text text-transparent sm:hidden'>Welcome, Joe Doe</p>
...
//       {
//         showCreateResume && (
//           <form onSubmit={createResume} onClick={() => setShowCreateResume(false)} className='fixed inset-0 bg-black/70 backdrop-blur bg-opacity-50 5-10 flex items-center justify-center'>
...
//       }
//       {showUploadResume && (
//         <form onSubmit={uploadResume} onClick={() => setShowUploadResume(false)} className='fixed inset-0 bg-black/70 backdrop-blur bg-opacity-50 5-10 flex items-center justify-center'>
//             <div onClick={e => e.stopPropagation()} className='relative bg-slate-50 border shadow-md rounded-lg w-full max-w-sm p-6'>
//               <h2>Create a Resume</h2>
//               <input onChange={(e) => setTitle(e.target.value)} value={title} type='text' placeholder='Enter resume title' className='w-full px-4 py-2 mb-4 focus:border-green-600 ring-green-600' required />

//               <div>
//                 <label htmlFor='resume-input' className=''>Select resume file
