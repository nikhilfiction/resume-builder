...
const Hero = () => {
    ...
    const logos = [instagramLogo, framerLogo, microsoftLogo, huaweiLogo, walmartLogo]
    ...
    <div className="min-h-screen pb-20">
        ...
        <nav className="z-50 flex items-center justify-between w-full py-4 px-6 md:px-16 lg:px-24 xl:px-40 text-sm">
            ...
            <div className="flex gap-2">
                <Link to='/app?state=register' className="hidden md:block px-6 py-2 bg-indigo-600 hover:bg-indigo-700 active:scale-95 transition-all rounded-full text-white" hidden={user}>
                    Get started
                </Link>
                ...
                <Link to='/app' className='hidden md:block px-8 py-2 bg-indigo-600 hover:bg-indigo-700 active:scale-95 transition-all rounded-full text-white' hidden={!user}>
                    Dashboard
                </Link>
            </div>
        ...
        <div className="relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-black">
            ...
            <h1 className="text-5xl md:text-6xl font-semibold max-w-5xl text-center mt-4 md:leading-[70px]">
                Land your dream job with <span className=" bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent text-nowrap">AI-powered </span> resumes.
            </h1>
            ...
            <div className="flex items-center gap-4 ">
                <Link to='/app' className="bg-indigo-600 hover:bg-indigo-700 text-white rounded-full px-9 h-12 m-1 ring-offset-2 ring-1 ring-indigo-400 flex items-center transition-colors">
                    Get started
